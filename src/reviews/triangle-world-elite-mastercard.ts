...
const review: CardEditorialReview = {
    ...
    seoTitle: 'Triangle World Elite Mastercard Review (2026) — Fees, Rewards & Is It Worth It?',
    ...
    whoItsFor: [
        ...
        'People who also buy groceries on this Mastercard and will stay under the annual grocery cap in our features, where World Elite currently pays 3% versus 1.5% on the base card.',
    ...
    whoShouldSkip: [
        ...
        'Anyone applying for a welcome bonus. Our current sheet does not list one.',
    ],
    pros: [
        ...
        '3% groceries on the first listed annual amount is a real step up from the base card’s 1.5% grocery slice in our data.',
